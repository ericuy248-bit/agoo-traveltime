...
const HIGHWAY_SEGMENTS = [
  ...
  { id: "I1_EW_EAST PART",
    label: "Verceles St. crossing at I1 (east to west)",
    origin: "16.326097159196078,120.36800871652888",
    destination: "16.325846,120.366633",
    expected_m: 150,
    has_expected: true},
  { id: "I1_WE_EAST PART",
    label: "Verceles St. crossing at I1 (west to east)",
    origin: "16.325846,120.366633",
  ...
  { id: "I1_EW_WEST PART",
    label: "Verceles St. crossing at I1 (east to west)",
    origin: "16.325846,120.366633",
    destination: "16.325606172334584,120.36524287899847",
    expected_m: 150,
    has_expected: true},
  { id: "I1_WE_WEST PART",
    label: "Verceles St. crossing at I1 (west to east)",
  ...
  { id: "I2_WE_EAST PART",
    label: "Grotto Road crossing at I2 (west to east)",
    origin: "16.323141,120.367084",
  ...
  { id: "I2_EW_WEST PART",
    label: "Cases Blvd crossing at I2 (east to west)",
    origin: "16.323141,120.367084",
    destination: "16.32283378947204,120.36569648947528",
    expected_m: 150,
    has_expected: true},
  ...
  { id: "I4_I3_NB", label: "I4->I3 northbound (Calvary to Cases/Asprer)",
    ...
    { id: "I3_EW_EAST PART",
    label: "G.tabora at I3 (east to west)",
    origin: "16.322326933481772,120.3687111660094",
    destination: "16.321961,120.367344",
    expected_m: 150,
    has_expected: true},
  { id: "I3_WE_EAST PART",
    label: "G.Tabora crossing I3 (west to east)",
    origin: "16.321961,120.367344",
  ...
  { id: "I3_EW_WEST PART",
    label: "T.asprer crossing at I3 (east to west)",
    origin: "16.321961,120.367344",
    destination: "16.321570481392243,120.36600291832497",
    expected_m: 150,
    has_expected: true},
  { id: "I3_WE_WEST PART",
    label: "T.asprer crossing at I3 (west to east)",
  ...
  { id: "S0_I4_NB", label: "S0 (~150m S of I4) -> I4 northbound (downstream approach)",
    ...
    { id: "I4_EW_EAST PART",
    label: "Calvary Road crossing at I4 (east to west)",
    origin: "16.320548400803762,120.36906968663082",
    destination: "16.320234,120.367705",
    expected_m: 150,
    has_expected: true},
   { id: "I4_WE_EAST PART",
    label: "Calvary Road crossing at I4 (west to east)",
    origin: "16.320234,120.367705",
  ...
  { id: "I4_EW_WEST PART",
    label: "Calvary Road crossing at I4(east to west)",
    origin: "16.320234,120.367705",
    destination: "16.31992513087929,120.36633827584097",
    expected_m: 150,
    has_expected: true},
  { id: "I4_WE_WEST PART",
    label: "Calvary Road crossing at I4 (west to east)",
